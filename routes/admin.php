<?php
    ...
    Route::middleware(['auth', 'verified'])->group(function () {
        ...
        Route::get('/dashboard', function () {
            ...
            })->name('dashboard')->middleware('permission:admin.dashboard');
        ...
        Route::prefix('admin')->name('admin.')->group(function () {
            ...
            Route::patch('/users/{id}/restore', [AdminAuthController::class, 'restore'])->middleware('permission:admin.user.restore')->name('user.restore');
            Route::delete('/users/{id}/force', [AdminAuthController::class, 'forceDelete'])->middleware('permission:admin.user.forcedelete')->name('user.forcedelete');
