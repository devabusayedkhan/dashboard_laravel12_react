        ...
        <AppLayout>
            ...
            <div className="space-y-6 p-4">
                <Heading
                    ...
                    description="Update your name, phone, email address and profile photo"
                />
                ...
                <form onSubmit={submit} className="space-y-6 skShadow p-4 rounded-lg">
                ...
                <button
                    type="button"
                    onClick={logOut}
                    className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-red-100 px-3 py-2 text-sm font-bold text-red-600 transition hover:bg-red-200"
                >
                    <span>Logout</span>
